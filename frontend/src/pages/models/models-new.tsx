...
import { create } from '../../stores/models/modelsSlice'
...
const ModelsNew = () => {
  ...
  <FormField label="Brand" labelFor="brand">
      <Field name="brand" id="brand" component={SelectField} options={[]} itemRef={'brands'}></Field>
  </FormField>
...
ModelsNew.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated>
          {page}
      </LayoutAuthenticated>
